...
ObservableList<String> companyList=FXCollections.observableArrayList("SCP","SCM","SCPM");
ObservableList<String> statusList=FXCollections.observableArrayList("Direction","Admin","Employé");
...
Statement statement = null;
    ...
    private void HandleOK(){
    	...
    	String company=Company.getSelectionModel().getSelectedItem().toString();
